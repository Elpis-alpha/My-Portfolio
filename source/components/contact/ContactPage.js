...
const ContactPage = () => {
  ...
  const sendContactMail = async (e) => {
    ...
    try {
      const msgRes = await postApiJson(
        sendMail(),
        {
          ...
          <form onSubmit={sendContactMail}>
            ...
            <div className="form-pack">
              <textarea
                ...
                required
                value={message}
                onInput={(e) => dispatch(setMessage(e.target.value))}
              ></textarea>
            </div>
        ...
        form {
          .form-pack {
            ...
            textarea {
              ...
              padding: 0 0.5pc;
              background: #f2f4f5;
              box-shadow: inset 8px 8px 31px #c2c3c4,
                inset -8px -8px 31px #ffffff;
              border-radius: 0.2pc;
              display: block;
            }
            textarea {
