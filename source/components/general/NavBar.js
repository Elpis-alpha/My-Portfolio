        ...
        <Link href="/">
          <a>
            <div className="head-image">
              <ElpisImage
                src="/images/blur/logo_small.png"
                alt="Elpis Logo"
                title="My Logo"
              />
            </div>
        ...
        <ul className={isNavOpened ? "show-nev" : ""}>
          ...
          <div className="two-nav">
            <li className="reveal-2">
              <Link href="/works">
                <a
                  className={currentURL === "/works" ? "active" : ""}
                  onClick={() => setIsNavOpened(false)}
                >
                  Works
                </a>
            ...
            <li className="reveal-3">
              <Link href="/stack">
                <a
                  className={currentURL === "/stack" ? "active" : ""}
                  onClick={() => setIsNavOpened(false)}
                >
                  Stack
                </a>
  ...
  @media screen and (max-width: 600px) {
    ...
    .children {
      ...
      ul {
        ...
        animation: slide-opacity 0.5s 0s 1;
        ...
        li {
          &.reveal-1 {
            animation: slide-opacity 0.3s 0s ease-in-out 1;
          }
          &.reveal-2 {
            animation: slide-opacity 0.5s 0s ease-in-out 1;
          }
          &.reveal-3 {
            animation: slide-opacity 0.7s 0s ease-in-out 1;
          }
          &.reveal-4 {
            animation: slide-opacity 0.8s 0s ease-in-out 1;
          }
          &.reveal-5 {
            animation: slide-opacity 0.9s 0s ease-in-out 1;
          }
